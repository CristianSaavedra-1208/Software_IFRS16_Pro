...
def calcular_ibr():
    ...
    generar_reporte(moneda, tasa_base, deudas, spread_ponderado, ibr_final, suma_capital)

def generar_reporte(moneda, tasa_base, deudas, spread_ponderado, ibr_final, suma_capital):
    ...
    with open(nombre_archivo, "w", encoding="utf-8") as f:
        ...
        if not deudas:
            ...
            f.write("Spread Ponderado = Sum( (Tasa Deuda - Tasa Ref Histórica) * Capital ) / Capital Total\n\n")
